    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        switch (type)
        {
            ...
            case EventScript.E_ModifierTargetType.timeline:
                var histRect = new Rect(x, y + lineH, w, lineH);
                EditorGUI.LabelField(histRect, "Legacy timeline modifier removed.");
                break;
            case EventScript.E_ModifierTargetType.gamelog:
                var loggerRect = new Rect(x, y + lineH, w, lineH);
                EditorGUI.LabelField(loggerRect, "Legacy game log modifier removed.");
                break;
        }
