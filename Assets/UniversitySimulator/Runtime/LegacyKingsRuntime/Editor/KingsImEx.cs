...
public class KingsImEx : EditorWindow {
    ...
    public string directory = "UniversitySimulator/ImEx";
    ...
    public void Export()
    {
        ...
        //string saveState = rowData.Count.ToString() + " entries saved to 'UniversitySimulator/TermList.txt' at " + DateTime.Now.ToShortTimeString() + ".";
    }
