...
public class TranslationManager : MonoBehaviour {
	...
	void saveListToFile(List<string> rowData){
		...
		//create path
		string directoryPath = Application.dataPath +"/UniversitySimulator";
		...
		saveState = rowData.Count.ToString() + " entries saved to 'UniversitySimulator/TermList.txt' at " + DateTime.Now.ToShortTimeString() +".";
	}
