  ...
  .:
    dependencies:
      '@napi-rs/canvas':
        ...
        version: 0.1.100
      '@oai/artifact-tool':
        specifier: file:./local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.13.tgz
        version: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.13.tgz
      '@viz-js/viz':
        specifier: 3.25.0
        version: 3.25.0
      docx:
...
packages:
  ...
  '@oai/artifact-tool@file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.13.tgz':
    resolution: {integrity: sha512-1+wVeeLcisBYktRnIoSHwJkAVGamOLLx5WGgD7hbAUVBrpSvqwyKcvCXRBlJAoNPvcIY+yYyU8phVZBKni0fsg==, tarball: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.13.tgz}
    version: 2.8.13
    bundledDependencies:
      - '@oai/walnut'
      - skia-canvas
